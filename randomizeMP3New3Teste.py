...
def prepareToRun():
	...
	Path('/home/marcospaulo/playedMP3.txt', '/home/marcospaulo/toPlayMP3.tmp', '/tmp/toPlayMP3.tmp').touch()
#	touch playedMP3.tmp toPlayMP3.txt /tmp/toPlayMP3.tmp;

	list=['/tmp/toPlayMP3.tmp','/home/marcospaulo/toPlayMP3.txt']
	for valor in list:
		os.chmod(valor, 0o600);
#	chmod 744 toPlayMP3.txt /tmp/toPlayMP3.tmp;

	toPlay=sum(1 for line in open(homePath + '/toPlayMP3.txt'))
#	toPlay=homePath + '/playedMP3.tmp', sum(1 for line in open(homePath + '/playedMP3.tmp'))
#	toPlay=$(cat toPlayMP3.txt | wc -l);
...
#		rm playedMP3.tmp;
#		toPlay=sum(1 for line in open(homePath + '/toPlayMP3.txt')) em prepareToRun()
#		toPlay=$(cat toPlayMP3.txt | wc -l);
#	fi
